...
<div class="d-none d-<?=$nav_expand?>-block upper-site-navbar<?php echo $menu_text_color_class.$content_above_navbar_bg_color; ?>">
	<div class="container py-2 px-3 d-flex justify-content-between align-items-center">
		<!-- Output site logo -->
		<?php site_logo(); ?>
  ...
  <div class="container">
    ...
    <?php wp_nav_menu(
      array(
        ...
        'container_id'    => 'navbarNavDropdown',
        'menu_class'      => 'navbar-nav ml-auto mb-3',
        'fallback_cb'     => '',
